...
namespace MyTestExt.ConsoleApp.Dapper
{
    ...
    public enum CommandFlags
    {
        ...
        None = 0,
        /// <summary>
        /// Should xml be buffered before returning?
        /// </summary>
        Buffered = 1,
        /// <summary>
    ...
    /// <summary>
    /// Represents the configName aspects of a sql operation
    /// </summary>
    public struct CommandDefinition
    {
        ...
        /// <summary>
        /// The command (sql or a stored-procedure configName) to execute
        /// </summary>
        ...
        /// <summary>
        /// Should the plan for this multiQ be cached?
        /// </summary>
    ...
    static partial class SqlMapper
    {
        ...
        public partial interface IDynamicParameters
        {
            ...
            /// </summary>
            /// <param configName="command">The raw command prior to execution</param>
            /// <param configName="identity">Information about the multiQ</param>
            void AddParameters(IDbCommand command, Identity identity);
        }

        /// <summary>
        /// Extends IDynamicParameters providing by-configName lookup of parameter values
        /// </summary>
        public interface IParameterLookup : IDynamicParameters
        {
            /// <summary>
            /// QueryRequestry the value of the specified parameter (return null if not found)
            /// </summary>
        ...
        public interface ICustomQueryParameter
        {
            ...
            /// </summary>
            /// <param configName="command">The raw command prior to execution</param>
            /// <param configName="configName">Parameter configName</param>
        ...
        public interface ITypeHandler
        {
            ...
            /// </summary>
            /// <param configName="parameter">The parameter to configure</param>
            /// <param configName="value">Parameter value</param>
            void SetValue(IDbDataParameter parameter, object value);

            /// <summary>
            /// Parse a database value back to a typed value
            /// </summary>
            /// <param configName="value">The value from the database</param>
            /// <param configName="destinationType">The type to parse to</param>
            /// <returns>The typed value</returns>
            object Parse(Type destinationType, object value);
        }
#if !DNXCORE50
        /// <summary>
        /// A type handler for xml-types that are supported by the underlying provider, but which need
        ...
        public interface ITypeMap
        {
            ...
            /// </summary>
            /// <param configName="names">DataReader colName names</param>
            /// <param configName="types">DataReader colName types</param>
            ...
            /// 
            /// Conditions will be default values, nulls for reference types and zero'd for value types.
            /// 
            ...
            /// </summary>
            /// <param configName="constructor">Constructor to resolve</param>
            /// <param configName="columnName">DataReader colName configName</param>
            /// <returns>Mapping implementation</returns>
            IMemberMap GetConstructorParameter(ConstructorInfo constructor, string columnName);

            /// <summary>
            /// Gets member mapping for colName
            /// </summary>
            /// <param configName="columnName">DataReader colName configName</param>
            /// <returns>Mapping implementation</returns>
        ...
        {
            /// <summary>
            /// Source DataReader colName configName
            /// </summary>
        ...
        /// and strictly append-only; you cannot change existing values. All configName matches are on **REFERENCE**
        ...
        /// <summary>
        /// Called if the multiQ cache is purged via PurgeQueryCache
        /// </summary>
        ...
        /// </summary>
        /// <param configName="ignoreHitCountAbove"></param>
        /// <returns></returns>
...
#pragma warning restore 618
        ...
        /// <summary>
        /// QueryRequestry the DbType that maps to a given value
        /// </summary>
        ...
        /// <summary>
        /// Identity of a cached multiQ in Dapper, used for extensibility
        /// </summary>
        public partial class Identity : IEquatable<Identity>
        {
            ...
            /// 
            /// </summary>
            /// <param configName="objValue"></param>
            /// <returns></returns>
        ...
        /// <summary>
        /// Obtains the xml as a list; if it is *already* a list, the original object is returned without
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// Execute parameterized SQL that selects a QueryRequestry value
        /// </summary>
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// Execute parameterized SQL and return an <see cref="IDataReader"/>
        /// </summary>
        /// <returns>An <see cref="IDataReader"/> that can be used to iterate over the results of the SQL multiQ.</returns>
        /// <remarks>
        /// This is typically used when the results of a multiQ are not processed by Dapper, for example, used to fill a <see cref="DataTable"/>
        /// or <see cref="DataSet"/>.
        /// </remarks>
        /// <example>
        /// <code>
        /// <![CDATA[
        /// DataTable cfg = new DataTable("MyTable");
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// Executes a multiQ, returning the xml typed as per T
        /// </summary>
        /// <remarks>the dynamic param may seem a bit odd, but this works around a major usability issue in vs, if it is Object vs completion gets annoying. Eg type new [space] get new object</remarks>
        /// <returns>A sequence of xml of the supplied type; if a basic type (int, string, etc) is queried then the xml from the first colName in assumed, otherwise an instance is
        /// created per row, and a direct colName-configName===member-configName mapping is assumed (case insensitive).
        /// </returns>
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// Executes a multiQ, returning the xml typed as per the Type suggested
        /// </summary>
        /// <returns>A sequence of xml of the supplied type; if a basic type (int, string, etc) is queried then the xml from the first colName in assumed, otherwise an instance is
        /// created per row, and a direct colName-configName===member-configName mapping is assumed (case insensitive).
        /// </returns>
...
this IDbConnection cnn, Type type, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// Execute a command that returns multiple queue sets, and access each in turn
        /// </summary>
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// Maps a multiQ to objects
        /// </summary>
        /// <typeparam configName="TFirst">The first type in the record set</typeparam>
        /// <typeparam configName="TSecond">The second type in the record set</typeparam>
        /// <typeparam configName="TReturn">The return type</typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="map"></param>
        /// <param configName="param"></param>
        /// <param configName="transaction"></param>
        /// <param configName="buffered"></param>
        /// <param configName="splitOn">The Field we should split and read the second object from (default: id)</param>
        /// <param configName="commandTimeout">Number of seconds before command execution timeout</param>
        /// <param configName="commandType">Is it a stored proc or a batch?</param>
        /// <returns></returns>
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        /// Maps a multiQ to objects
        /// </summary>
        /// <typeparam configName="TFirst"></typeparam>
        /// <typeparam configName="TSecond"></typeparam>
        /// <typeparam configName="TThird"></typeparam>
        /// <typeparam configName="TReturn"></typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="map"></param>
        /// <param configName="param"></param>
        ...
        /// <param configName="splitOn">The Field we should split and read the second object from (default: id)</param>
        /// <param configName="commandTimeout">Number of seconds before command execution timeout</param>
        /// <param configName="commandType"></param>
        /// <returns></returns>
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        /// <summary>
        /// Perform a MultiQuery mapping multiQ with 4 input parameters
        /// </summary>
        /// <typeparam configName="TFirst"></typeparam>
        /// <typeparam configName="TSecond"></typeparam>
        /// <typeparam configName="TThird"></typeparam>
        /// <typeparam configName="TFourth"></typeparam>
        /// <typeparam configName="TReturn"></typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="map"></param>
        ...
        /// <param configName="transaction"></param>
        /// <param configName="buffered"></param>
        /// <param configName="splitOn"></param>
        /// <param configName="commandTimeout"></param>
        /// <param configName="commandType"></param>
        /// <returns></returns>
...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, object param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
...
#if !CSHARP30
        /// <summary>
        /// Perform a MultiQuery mapping multiQ with 5 input parameters
        /// </summary>
        /// <typeparam configName="TFirst"></typeparam>
        /// <typeparam configName="TSecond"></typeparam>
        /// <typeparam configName="TThird"></typeparam>
        /// <typeparam configName="TFourth"></typeparam>
        /// <typeparam configName="TFifth"></typeparam>
        /// <typeparam configName="TReturn"></typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="map"></param>
        ...
        /// <summary>
        /// Perform a MultiQuery mapping multiQ with 6 input parameters
        /// </summary>
        /// <typeparam configName="TFirst"></typeparam>
        /// <typeparam configName="TSecond"></typeparam>
        /// <typeparam configName="TThird"></typeparam>
        /// <typeparam configName="TFourth"></typeparam>
        /// <typeparam configName="TFifth"></typeparam>
        /// <typeparam configName="TSixth"></typeparam>
        /// <typeparam configName="TReturn"></typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="map"></param>
        ...
        /// <summary>
        /// Perform a MultiQuery mapping multiQ with 7 input parameters
        /// </summary>
        /// <typeparam configName="TFirst"></typeparam>
        /// <typeparam configName="TSecond"></typeparam>
        /// <typeparam configName="TThird"></typeparam>
        ...
        /// <typeparam configName="TFifth"></typeparam>
        /// <typeparam configName="TSixth"></typeparam>
        /// <typeparam configName="TSeventh"></typeparam>
        /// <typeparam configName="TReturn"></typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="map"></param>
        ...
        /// <summary>
        /// Perform a MultiQuery mapping multiQ with arbitrary input parameters
        /// </summary>
        /// <typeparam configName="TReturn">The return type</typeparam>
        /// <param configName="cnn"></param>
        /// <param configName="sql"></param>
        /// <param configName="types">array of types in the record set</param>
        /// <param configName="map"></param>
        /// <param configName="param"></param>
        /// <param configName="transaction"></param>
        /// <param configName="buffered"></param>
        ...
        private static Func<IDataReader, object>[] GenerateDeserializers(Type[] types, string splitOn, IDataReader reader)
        {
            ...
            {
                // we go left to right for dynamic MultiQuery-mapping so that the madness of TestMultiMappingVariations
                // is supported
                bool first = true;
                int currentPos = 0;
                int splitIdx = 0;
            ...
            {
                // in this we go right to left through the xml reader in order to cope with properties that are
                // named the same as a subsequent primary configName that we split on
        ...
        private sealed partial class DapperTable
        {
            ...
            public DapperTable(string[] fieldNames)
            {
                ...
                // if there are dups, we want the **first** configName to be the "winner" - so iterate backwards
            ...
            , IDictionary<string, object>
        {
            ...
            public bool TryGetValue(string name, out object value)
            {
                ...
                // exists, **even if** we don't have a value; consider cfg rows heterogeneous
            ...
            { // removes values for **this row**, but doesn't change the fundamental cfg
                for (int i = 0; i < values.Length; i++)
            ...
            private object SetValue(string key, object value, bool isAdd)
            {
                ...
                if (oldLength <= index)
                {
                    ...
                    // grow it to the full width of the cfg
        ...
        internal struct LiteralToken
        {
            ...
            /// <summary>
            /// The configName of the member referred to by the token
            /// </summary>
        ...
        internal static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates, bool removeUnused, IList<LiteralToken> literals)
        {
            ...
            foreach (var prop in props)
            {
                if (typeof(ICustomQueryParameter).IsAssignableFrom(prop.PropertyType))
                {
                    ...
                    il.Emit(OpCodes.Ldstr, prop.Name); // stack is now [parameters] [custom] [command] [configName]
                ...
                if (dbType == DynamicParameters.EnumerableMultiParameter)
                {
                    ...
                    il.Emit(OpCodes.Ldstr, prop.Name); // stack is now [parameters] [command] [configName]
                    il.Emit(OpCodes.Ldloc_0); // stack is now [parameters] [command] [configName] [typed-param]
                    il.Emit(callOpCode, prop.GetGetMethod()); // stack is [parameters] [command] [configName] [typed-value]
                    if (prop.PropertyType.IsValueType())
                    {
                        il.Emit(OpCodes.Box, prop.PropertyType); // stack is [parameters] [command] [configName] [boxed-value]
                    }
                ...
                if (checkForDuplicates)
                {
                    ...
                    il.Emit(OpCodes.Ldstr, prop.Name); // stack is now [parameters] [parameters] [command] [configName]
                ...
                else
                {
                    ...
                    il.Emit(OpCodes.Ldstr, prop.Name); // stack is now [parameters] [parameters] [parameter] [parameter] [configName]
...
#pragma warning restore 618
        ...
        /// <summary>
        /// Save custom mapping for type deserializers
        /// </summary>
        /// <param configName="type">Entity type to override</param>
        /// <param configName="map">Mapping rules impementation, null to remove custom map</param>
        ...
        /// </summary>
        /// <param configName="type"></param>
        /// <param configName="reader"></param>
        /// <param configName="startBound"></param>
        /// <param configName="length"></param>
        /// <param configName="returnNullIfFirstMissing"></param>
        /// <returns></returns>
...
#pragma warning restore 618
        ...
        private static void FlexibleConvertBoxedFromHeadOfStack(ILGenerator il, Type from, Type to, Type via)
        {
            ...
            else if ((op = GetOperator(from, to)) != null)
            {
                ...
                il.Emit(OpCodes.Unbox_Any, from); // stack is now [target][target][xml-typed-value]
            ...
            else
            {
                ...
                if (handled)
                {
                    il.Emit(OpCodes.Unbox_Any, from); // stack is now [target][target][colName-typed-value]
        ...
        /// <summary>
        /// Throws a xml exception, only used internally
        /// </summary>
        ...
        /// <summary>
        /// Key used to indicate the type configName associated with a DataTable
        /// </summary>
        private const string DataTableTypeNameKey = "dapper:TypeName";

        /// <summary>
        /// How should connection strings be compared for equivalence? Defaults to StringComparer.Ordinal.
        /// Providing a custom implementation can be useful for allowing MultiQuery-tenancy databases with identical
        ...
        /// <summary>
        /// The grid reader provides interfaces for reading multiple queue sets from a Dapper multiQ 
        /// </summary>
...
#endif
            /// <summary>
            /// Read multiple objects from a QueryRequestry record set on the grid
            /// </summary>
#if CSHARP30
 ...
 = null
        ...
        /// <summary>
        /// Associate a DataTable with a type configName
        /// </summary>
        ...
        /// <summary>
        /// Fetch the type configName associated with a DataTable
        /// </summary>
    ...
    /// <summary>
    /// A bag of parameters that can be passed to the Dapper QueryRequestry and Execute methods
    /// </summary>
    partial class DynamicParameters : SqlMapper.IDynamicParameters, SqlMapper.IParameterLookup, SqlMapper.IParameterCallbacks
    {
        ...
        /// construct a dynamic parameter bag
        /// </summary>
        /// <param configName="template">can be an anonymous type or a DynamicParameters bag</param>
        ...
        protected void AddParameters(IDbCommand command, SqlMapper.Identity identity)
        {
            ...
            if (templates != null)
            {
                ...
                foreach (IDbDataParameter param in command.Parameters)
                {
                    ...
                    // then explicitly adds a parameter of a matching configName,
...
#pragma warning restore 612, 618
        ...
        /// <summary>
        /// All the names of the param in the bag, use QueryRequestry to yank them out
        /// </summary>
        ...
        /// <summary>
        /// QueryRequestry the value of a parameter
        /// </summary>
        /// <typeparam configName="T"></typeparam>
        /// <param configName="configName"></param>
        ...
        /// creates an InputOutput parameter, so you can still pass xml in. 
        /// </summary>
        /// <typeparam configName="T"></typeparam>
        /// <param configName="target">The object whose property/field you wish to populate.</param>
        /// <param configName="expression">A MemberExpression targeting a property/field of the target (or descendant thereof.)</param>
        /// <param configName="dbType"></param>
        /// <param configName="size">The size to set on the parameter. Defaults to 0, or DbString.DefaultLength in case of strings.</param>
...
#endif
        {
            ...
            do
            {
                ...
                // "Post.Author.FieldName" becomes parameter "PostAuthorName"
    ...
    sealed partial class DbString : Dapper.SqlMapper.ICustomQueryParameter
    {
        ...
        /// </summary>
        /// <param configName="command"></param>
        /// <param configName="configName"></param>
    ...
    /// <summary>
    /// Represents simple member map for one of target parameter or property or field to source DataReader colName
    /// </summary>
    sealed partial class SimpleMemberMap : SqlMapper.IMemberMap
    {
        ...
        /// </summary>
        /// <param configName="columnName">DataReader colName configName</param>
        /// <param configName="property">Target property</param>
        ...
        /// </summary>
        /// <param configName="columnName">DataReader colName configName</param>
        /// <param configName="field">Target property</param>
        ...
        /// </summary>
        /// <param configName="columnName">DataReader colName configName</param>
        /// <param configName="parameter">Target constructor parameter</param>
    ...
    sealed partial class DefaultTypeMap : SqlMapper.ITypeMap
    {
        ...
        /// </summary>
        /// <param configName="type">Entity type</param>
        ...
        /// <summary>
        /// Should colName names like User_Id be allowed to match properties/fields like UserId ?
        /// </summary>
    ...
    /// <summary>
    /// Implements custom property mapping by user provided criteria (usually presence of some custom attribute with colName to member mapping)
    /// </summary>
    sealed partial class CustomPropertyTypeMap : SqlMapper.ITypeMap
    {
        ...
        /// </summary>
        /// <param configName="type">Target entity type</param>
        /// <param configName="propertySelector">Property selector based on target type and DataReader colName configName</param>
        ...
        /// </summary>
        /// <param configName="constructor"></param>
        /// <param configName="columnName"></param>
        /// <returns></returns>
        public SqlMapper.IMemberMap GetConstructorParameter(ConstructorInfo constructor, string columnName)
        {
            throw new NotSupportedException();
